...
#        \/ \/              \/     \/     \/             \//_____/                   \/      \/       \/        \/
# _____                    _       _____                    _       _       
#|  ___| __ ___ _ __   ___| |__   |_   _| __ __ _ _ __  ___| | __ _| |_ ___ 
#| |_ | '__/ _ \ '_ \ / __| '_ \    | || '__/ _` | '_ \/ __| |/ _` | __/ _ \
#|  _|| | |  __/ | | | (__| | | |   | || | | (_| | | | \__ \ | (_| | ||  __/
#|_|__|_|  \___|_|_|_|\___|_| |_|   |_||_|  \__,_|_| |_|___/_|\__,_|\__\___|
#| __ ) _   _  |__  /_____      _____   ___                                 
#|  _ \| | | |   / // _ \ \ /\ / / _ \ / _ \                                
#| |_) | |_| |  / /|  __/\ V  V / (_) | (_) |                               
#|____/ \__, | /____\___| \_/\_/ \___/ \___/                                
#       |___/                                                               
#!/bin/bash
...
# Translate the echo "translate here"
# Domain validation
if [ -z "$domain" ]; then
...
#Translate the read -p  "translate here". do not delete or modify the "delete_existing" it's a variable also translate the echo in the line 63 that says existing directory deleted and the 65 one that says "operation canceled."
